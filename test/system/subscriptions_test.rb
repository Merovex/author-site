...
class SubscriptionsTest < ApplicationSystemTestCase
  ...
  test "creating a Subscription" do
    ...
    fill_in "Confirmation set at", with: @subscription.confirmation_set_at
    fill_in "Confirmation token", with: @subscription.confirmation_token
    fill_in "Confirmed at", with: @subscription.confirmed_at
