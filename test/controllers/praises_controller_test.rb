...
class PraisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create praise" do
    assert_difference('Praise.count') do
      post praises_url, params: { praise: { book_id: @praise.book_id, title: @praise.title } }
    end
  ...
  test "should update praise" do
    patch praise_url(@praise), params: { praise: { book_id: @praise.book_id, title: @praise.title } }
